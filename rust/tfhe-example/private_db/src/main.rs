...
fn main() {
    ...
    println!("\n{}", "=".repeat(80));
    println!("TFHE Private Database Query");
    println!("{}\n", "=".repeat(80));
    ...
    match mode {
        "real" => {
            ...
            println!("Running actual private database query on encrypted data\n");
...
fn print_help() {
    ...
    println!("Modes:");
    println!("  real      - Run real private database query (default)");
